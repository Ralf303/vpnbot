...
- OpenVPN завершается на российском сервере: российские IPv4-сети выходят в интернет из Москвы, остальные — через защищённый межсерверный канал и финский exit. С 8 сентября выбран SSH/TCP вместо недоступного WireGuard.
