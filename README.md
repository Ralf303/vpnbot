...
- Пользователь может пересоздать активный конфиг: срок и название сохраняются, новый сертификат создаётся на менее загруженном доступном VPS, а старый отзывается.
