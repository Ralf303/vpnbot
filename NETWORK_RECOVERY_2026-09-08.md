...
> Исторический документ. 9 сентября обнаружены повторяющиеся разрывы SSH
> `peer ignored channel window`, затем недоступность публичного адреса FI
> из нескольких сетей. Действующий выход перенесён на WireGuard в Германии:
> [NETWORK_FAILOVER_2026-09-09.md](NETWORK_FAILOVER_2026-09-09.md).
