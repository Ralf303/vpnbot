...
Для действующей московской точки входа установка аварийного управления и откат
описаны в [EMERGENCY_MANAGEMENT.md](EMERGENCY_MANAGEMENT.md). VK теперь также
обслуживает аварийную админку и запускается независимо от Telegram.
