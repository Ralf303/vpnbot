...
Управление несколькими выходами и установка новых VPS из бота описаны в
[EMERGENCY_MANAGEMENT.md](EMERGENCY_MANAGEMENT.md). Реестр назначений находится
на Москве; клиентские сертификаты на зарубежные VPS не копируются.

Обновление от 9 сентября 2026: production использует WireGuard `wg-de` между
Москвой и резервом в Германии с сохранением GeoIP-разделения. Перед применением
исходных инструкций ниже прочитайте
[NETWORK_FAILOVER_2026-09-09.md](NETWORK_FAILOVER_2026-09-09.md): там перечислены
текущие службы, конфигурация транспорта и порядок восстановления.
