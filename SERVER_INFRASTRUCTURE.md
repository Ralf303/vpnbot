...
Обновление от 8 сентября 2026: production использует SSH/TCP `tun99` для
межсерверного трафика с сохранением GeoIP-разделения. Перед применением
инструкций WireGuard ниже прочитайте
[NETWORK_RECOVERY_2026-09-08.md](NETWORK_RECOVERY_2026-09-08.md): там перечислены
текущие службы, конфигурация транспорта и порядок отката.
